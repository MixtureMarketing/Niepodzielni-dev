{{-- Template Name: Konsultacje Niskopłatne --}}
...
<div class="psy-page-wrapper">
    ...
    @include('partials.psy-listing.organisms.bk-shared-calendar', ['rodzaj' => 'nisko'])

    @include('partials.psy-listing.organisms.filter-bar', ['rodzaj' => 'nisko'])
