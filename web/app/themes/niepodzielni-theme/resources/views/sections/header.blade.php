...
<header id="site-header" class="site-header">
    <div class="psy-container header-flex">
        ...
        <div class="header-actions">
            ...
            {{-- BURGER (TRIGGER) --}}
            <button type="button" class="burger" aria-expanded="false" aria-controls="mega-menu" aria-label="Otwórz menu">
                <span></span>
                <span></span>
                <span></span>
            </button>
...
{{-- MEGA MENU CONTENT --}}
<nav id="mega-menu" class="mega_menu" aria-label="Menu główne" aria-hidden="true">
