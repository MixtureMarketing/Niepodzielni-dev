...
/**
 * Logic: Psychologist Listing (Pre-loaded JSON approach)
 *
...
function get_psy_listing_json_data($rodzaj = 'nisko')
{
    ...
    foreach ($query->posts as $post) {
        ...
        // Pobierz każdą taksonomię raz i używaj lokalnej zmiennej
        ...
        $all_psy_data[] = [
            ...
            'jezyki'     => $jezyki_data, // New structured data
...
add_action('save_post_psycholog', 'np_clear_psy_listing_cache');
add_action('niepodzielni_bookero_batch_synced', 'np_clear_psy_listing_cache');
function np_clear_psy_listing_cache()
{
